...
- vue
- 前端
permalink: vue-use-mock-data-component-communication
---
#### 一、配置模拟数据
1.在static文件夹下新增mock文件夹

2.在mock文件夹下新建index.json文件，写入mock data如下：
<!--more-->
```json
{
  "ret": true,
